...
import javaFromScratch.entities.Pensionate;
...
public class Main {
    ...
    public static void main(String[] args) { // aqui é o entry point do algoritmo Java, veja o first()
        // double[] myNumberArray = {8.00, 5, 8};
        // out.println(Calculator.sum(myNumberArray));
        // out.println(Calculator.subtract(21));
    ...
    public static void printPensionate() {
        Pensionate pens = new Pensionate(10);
        Integer[] roomsToRent = new Integer[] { 5, 2, 9 };
        String[] renters = new String[] { "Maria", "João", "Pedro" };
        pens.rentRooms(roomsToRent, renters);
        pens.showRentedRooms();
    }
}
